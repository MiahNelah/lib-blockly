...
Hooks.once('ready', () => {
    game.modules.get("libblockly")
        ...
        .addCategory("Rolltable")
        .addBlock("block", "foundry_rolltable_roll_table")
        .addBlock("block", "foundry_rolltable_get_rolltable_dropdown")
        .addBlock("block", "foundry_rolltable_get_data_from_tableresult");
})
